...
class FSSSourcesView : public QSplitter {
 ...
 signals:
  void resourceSelected(data_res_class_t resource_class, unsigned int index);

 public slots:
  void addSource(data_source_t *source);
  void onResourceSelected(data_res_class_t resource_class, unsigned int index);
};
